...
# bir grid olşturuyoruz (GridSearchCV)
...
# neredeyse tüm metrikler de hiperparametre optimizasyonunun sonuç verdiğini görüyoruz
...
def val_curve_params(model, X, y, param_name, param_range, scoring="roc_auc", cv=10):
    ...
    plt.legend(loc='best')
    plt.show(block=True)
# arka plan da her bir max_depth parametresi için 500 ağaç fit ediliyor.

val_curve_params(rf_final, X, y, "max_depth", range(1, 11), scoring="roc_auc")
# Sonuç: max_depth arttıkça train_score da artış olmuş
...
# şu haliyle LghtGBM'in son halinden iyi gibi gözüküyor
